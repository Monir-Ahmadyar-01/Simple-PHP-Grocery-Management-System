                    ...
                    <div class="card fat" style="">
                        <div class="card-body">
                            <button class="btn btn-primary"
                                onclick="window.open('manage_item.php','_self');">back</button>
                            <a href="rejected_item.php?barcode=<?php echo $_GET["barcode"]; ?>"><button
                                    class="btn btn-warning">Rejected Item</button></a>
										...
										if(isset($_POST["btn_submit"])){
											...
											$sql_query_04  = mysqli_query($connection , "INSERT INTO `plus_item` (`id`, `barcode`, `name`, `mount`, `buy_price`, `sell_price`,`date`)
											 ...
											 if ($sql_query_04) {
                                                    ...
                                                    $sql_query_07 = mysqli_query($connection,"update item_store set mount='$up_mount',buy_price='$buy_price',sell_price='$sell_price',date='$date' where barcode='$get_barcode'");
											 		if($sql_query_07){
