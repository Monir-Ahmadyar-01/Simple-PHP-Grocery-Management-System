                            ...
                            <form method="POST" id="uploadForm" class="my-login-validation"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                <tr style="background-color:gray; color:white; ">
                                                    <th colspan="4" style="text-align:center;">Catomers</th>
                                                </tr>
                                                <tr>
                                                    <th>No</th>
                                                    <th colspan='3' style="text-align:center;">Castomer Name
                                                    </th>
                                                    <!-- <th>mount</th>
                                                <th>sell_price</th> -->
                                                </tr>
                                                ...
                                                $sql_query = mysqli_query($connection,"select DISTINCT to_detail from stored_item where date like '$today_date'");
                                                $count = 1;
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                        ...
                                                        $sql_query_02 = mysqli_query($connection,"select *  from stored_item where to_detail='$to_detail' and date like '$today_date'");
                                                        $count_02 = 1;
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                ...
                                                <?php
                                                $sql_query2 = mysqli_query($connection,"select name,mount from item_store where date like '$today_date'");
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered " id="mytable">
                                                ...
                                                <?php
                                                    $sql_query3;
                                                    $sql_query3 = mysqli_query($connection,"select id,code,description,amount,price1,status from item_expenses where date_sh like '$today_date'");
                                                ?>
                                                <script>
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                ...
                                                <?php
                                                $sql_query4 = mysqli_query($connection,"select name,mount,buy_price from plus_item where date like '$today_date'");
                                    ...
                                    <tr>
                                        <?php
                                            // total Stored Drug
                                            $sql_query5 = mysqli_query($connection,"select sum(mount*sell_price) as total from stored_item where date like '$today_date'");
                                        ...
                                        <?php
                                            ...
                                            $sql_query6 = mysqli_query($connection,"select sum(received-buy_amount) as total_price from company_account where date_sh like '$today_date'");
                                        ...
                                        <?php
                                            // total expense
                                            $sql_query7 = mysqli_query($connection,"select sum(price1*amount) as total_price from item_expenses where date_sh like '$today_date' and status='true'");
