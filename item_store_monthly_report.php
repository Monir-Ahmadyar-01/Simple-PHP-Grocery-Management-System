                ...
                <div class="card-wrapper" style="width:100%;margin-top:1%; ">
                    <div class="card fat" style="">
                        <div class="card-body">
                            ...
                            <h2 class="card-title" style="text-align:center;">Total Pharmacy (Month
                                <?php echo jdate("m","","","Asia/kabul","en"); ?>) Report</h2>
                            <hr>
                            <form method="POST" id="uploadForm" class="my-login-validation"
                                enctype="multipart/form-data" novalidate="">
                                <table class="table table-bordered">
                                    <tr style="background-color:#144b6f;color:white;">
                                        <th colspan="2">Stored Items</th>
                                        <th colspan="2">Repository</th>
                                        <th colspan="2">Expenses</th>
                                        <th colspan="2">Added Items</th>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                ...
                                                <?php
                                                $this_month = jdate("m/Y","","","Asia/kabul","en");
                                                $sql_query = mysqli_query($connection,"select DISTINCT to_detail from stored_item where date like '%$this_month%'");
                                                $count = 1;
                                            ...
                                            ?>
                                                ...
                                                <?php
                                                        ...
                                                        $sql_query_02 = mysqli_query($connection,"select *  from stored_item where to_detail='$to_detail' and date like '%$this_month%'");
                                                        $count_02 = 1;
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                ...
                                                <?php
                                                $sql_query2 = mysqli_query($connection,"select name,mount from item_store where date like '%$this_month%'");
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered " id="mytable">
                                                ...
                                                <?php
                                                    $sql_query3;
                                                    $sql_query3 = mysqli_query($connection,"select id,code,description,amount,price1,status from item_expenses where date_sh like '%$this_month%'");
                                                ?>
                                                <script>
                                        ...
                                        <td colspan="2">
                                            <table class="table table-bordered ">
                                                ...
                                                <?php
                                                $sql_query4 = mysqli_query($connection,"select name,mount,buy_price from plus_item where date like '%$this_month%'");
                                    ...
                                    <tr>
                                        <?php
                                            // total Stored Drug
                                            $sql_query5 = mysqli_query($connection,"select sum(mount*sell_price) as total from stored_item where date like '%$this_month%'");
                                        ...
                                        <?php
                                            ...
                                            $sql_query6 = mysqli_query($connection,"select sum(received-buy_amount) as total_price from company_account where date_sh like '%$this_month%'");
                                        ...
                                        <?php
                                            // total expense
                                            $sql_query7 = mysqli_query($connection,"select sum(price1*amount) as total_price from item_expenses where date_sh like '%$this_month%' and status='true'");
                                        ...
                                        <!-- <?php
                                            ...
                                            // $sql_query8 = mysqli_query($connection,"select sum(mount*buy_price) as total_price from plus_drugs where date like '$today_date'");
