...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'ap_inventry');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'C:\xampp\htdocs\AP-Inventry system\backup'); // Comment this line to use same script's directory ('.')
...
$backupDatabase = new Backup_Database("localhost", "root", "", "ap_inventry","utf8");
